...
class GameFragmentAssistant(
    ...
    fun hideKeyboard() {
        (gameFragment.inputMethodManager as? InputMethodManager)?.hideSoftInputFromWindow(
            gameFragment.sentence_line.windowToken,
    ...
    fun getTextWatcher(): TextWatcher {
        return object : TextWatcher {
            ...
            override fun afterTextChanged(text: Editable) {
                if (text.toString().length > 2) makeVisibleBtnSend()
            }
        }
    }
